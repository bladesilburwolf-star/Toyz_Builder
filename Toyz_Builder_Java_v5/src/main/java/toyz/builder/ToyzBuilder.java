            ...
            if (appState == AppState.Title) {
                ...
                if (titleMenu.showSettings) {
                    ...
                    if (tact == UI.TitleAction.NewWorld) {
                        // New seed + new terrain. Do NOT UnloadModel here — Jaylib/JavaCPP
                        // UnloadModel mid-session causes STATUS_HEAP_CORRUPTION (0xC0000374) on Windows.
                        // Old GPU resources leak until process exit (OS reclaims). Safe for desktop beta.
                        placedPieces.clear();
                        selectedIndex = -1;
