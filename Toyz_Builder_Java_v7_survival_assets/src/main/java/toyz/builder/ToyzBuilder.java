...
public final class ToyzBuilder {
    ...
    public static void main(String[] args) {
        ...
        while (!WindowShouldClose()) {
            ...
            if (Survival.enabled && IsKeyPressed(KEY_C) && !pauseMenu.open && !inventory.isOpen) {
            ...
            if (!menuOpen) {
                ...
                if (Survival.enabled) {
                    ...
                    if (!isPlacing && !menuOpen && !Survival.showCraft && IsMouseButtonPressed(MOUSE_BUTTON_LEFT))
                        Survival.attackNearest(player);
                }
            }
            ...
            if (Survival.enabled) Survival.drawHud();
