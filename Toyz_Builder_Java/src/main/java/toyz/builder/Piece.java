...
public final class Piece {
    ...
    public static void unloadPieceDefs(List<PieceDef> defs) {
        ...
        defs.clear();
        if (texBark != null)   { UnloadTexture(texBark);   texBark = null; }
        if (texMetal != null)  { UnloadTexture(texMetal);  texMetal = null; }
        if (texPlanks != null) { UnloadTexture(texPlanks); texPlanks = null; }
        if (texStone != null)  { UnloadTexture(texStone);  texStone = null; }
        if (texGlass != null)  { UnloadTexture(texGlass);  texGlass = null; }
    }
